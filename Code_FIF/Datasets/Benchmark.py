""" Compute FIF score with Dyadic_indicator dictionary and
    L2 scalar product on the thirteen real dataset of the paper.
...
y8_test2 = np.array(starlightcurves2, dtype=float)[:,0]
...
with open("Benchmark.csv", "w") as f_write:
