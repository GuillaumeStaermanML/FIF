""" Compute FIF score with self dictionary and
...
if __name__ == '__main__': # excute on main process only
    #with Pool(4) as p:
    p = Pool(13)
    result_self2 = p.map(benchself2, l) # list of length l of 4 list, result[0] give the 4 list for l=10
